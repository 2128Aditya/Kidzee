        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-10">
          <div>
            <div className="flex items-center gap-2 mb-6">
              <div className="w-10 h-10 bg-secondary rounded-full flex items-center justify-center font-bold text-primary text-xl">
                K
              </div>
              <span className="text-white font-bold text-2xl tracking-wide">Kidzee</span>
            </div>
            <p className="text-bg-light/80 text-sm leading-relaxed mb-6">
              Nurturing young minds with love and care. We provide a safe, engaging, and creative environment for your child's early development.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="flex flex-col gap-3">
              {['Home', 'About Us', 'Our Programmes', 'Admissions', 'Contact'].map(link => (
                <li key={link}>
